...
source(here("utils","initial_team_selection - total points best 11.R"))
source(here("utils","team_rules_checks.R"))


fdr_df <- read_csv(here(paste0("data/processed/fdr/season ",curr_season,"/upcoming_season.csv")))
...
optimal_starting_team %>%
  ...
  write_csv(here(paste0("data/starting team/season ",curr_season," Alt"),
