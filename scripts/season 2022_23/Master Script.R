...
# Path to the scripts
script1 <- here("scripts/season 2022_23","6. Prep Data For Prediction.R")
script2 <- here("scripts/season 2022_23","7. Predict Upcoming Week - XGB Reg.R")
script3 <- here("scripts/season 2022_23","8. Weekly Transfer.R")
# gw_script <- here("scripts/season 2022_23","99. Constants.R")

gw <- 1
first_season <- "2020_21"
prev_season <- "2021_22"
curr_season <- "2022_23"
