...
current_season_fdr_df <- 
  read_csv(here(paste0("data/raw/",str_replace(curr_season,coll("_"),"-")),
                "fixtures.csv"))
...
historical_df <- 
  import_historical_data(paste0("data/processed/historical/season ",
                                curr_season))
...
single_gw_df <- 
  import_all_gws(paste0("data/processed/upcoming/season ",curr_season),
                 curr_season)
