...
# **** Team Strength Data ----
season_2023_24_fdr <- read_csv(here("data/raw/2023-24","fixtures.csv"))
...
upcoming_gw %>% 
  ...
  write_csv(here("data/processed/upcoming",
                 paste0("gw",gw,".csv")))

# Move Previous GW file to Historical Folder ----
if (file.exists(here(paste0("data/processed/upcoming"),
                     paste0("gw",gw-1,".csv")))) {
  
  # Remove the file
  file_removed <- file.remove(here(paste0("data/processed/upcoming"),
                                   paste0("gw",gw-1,".csv")))
